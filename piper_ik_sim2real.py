...
def main():
    ...
    # 加载 Piper （仿真）
    piper_robot = scene.add_entity(gs.morphs.MJCF(file="/Users/huyiyang/Downloads/agilex_piper/piper.xml"))
    ...
    piper_robot.set_dofs_kv(np.array([550, 550, 550, 550, 200, 200, 10, 10]))
    piper_robot.set_dofs_kp(np.array([6000, 6000, 6000, 6000, 3000, 3000, 200, 200]))
    ...
    try:
        ...
        time.sleep(10)
        controller.target_pos = np.array([0.16, 0.002, 0.20], dtype=np.float32)  
        time.sleep(30)
