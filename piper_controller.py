...
class PiperController:
    ...
    # def print_status(self, delta_pos, current_pos):
    #     """打印状态信息（限制频率）"""
    ...
    #         table.add_row("current_x:", f"{current_pos[0]}")
    #         table.add_row("current_y:", f"{current_pos[1]}")
    #         table.add_row("current_z:", f"{current_pos[2]}")
    #         table.add_row("", "")  # 空行
